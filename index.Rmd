...
ggplot(cpp2010) + geom_point(aes(x = MedianInc, y = AvgCPC)) +
  labs(x = "Median Income 2010", y = "Crime Per Capita 2010", title = "Relationship between Median Income and Crime Per Capita in 2010")

```
```{r}
ggplot(cpp2017) + geom_point(aes(x = MedianInc, y = AvgCPC)) +
  labs(x = "Median Income 2017", y = "Crime Per Capita 2017", title = "Relationship between Median Income and Crime Per Capita in 2017")
...
ggplot(avghom2017) + geom_point(aes(x = MedianInc, y = Homicide)) + labs(x = "Median Income 2017", y = "Crime Per Capita 2017", title = "Relationship between Median Income and Homicide Per Capita in 2017")
```
...
grid.arrange(mapinc17, hom2010map, nrow = 1)
```
